...
export default function Footer() {
  ...
  return (
    <footer className="bg-surface-container-low py-24 flex flex-col items-center justify-center text-center px-margin-mobile border-t border-secondary-fixed/50">
